...
SAXON="java ${JAVA_OPTIONS} -jar ${EXIST_HOME}/lib/Saxon-HE-9.9.1-2.jar env=${EXIST_ENV} context_path=${EXIST_CONTEXT_PATH} default_app_path=${EXIST_DEFAULT_APP_PATH} -xsl:${EXIST_HOME}/adjust-conf-files.xsl"
